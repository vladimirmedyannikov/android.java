...
public class DragSortListView extends ListView {
     ...
     * through to {@link com.mobeta.android.dslv.DragSortListView.DropListener#drop(int, int)}.
     *
    ...
    public interface FloatViewManager {
         ...
         *                      and the offset provided in {@link com.mobeta.android.dslv.DragSortListView#startDrag}.
    ...
    public void moveCheckState(int from, int to) {
        ...
        // clearAll a check mark at the other end:
        // X . X X X . X X
