package ru.mos.polls.innovation.view;
...
/**
 * Исопльзуется на экране детальной информации о городской новинке {@link ru.mos.polls.innovation.gui.activity.InnovationActivity}
