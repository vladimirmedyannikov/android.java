...
public abstract class NavigateFragment<VM extends FragmentViewModel, B extends ViewDataBinding> extends BindingFragment<VM, B> implements RequestInterfaceListener {
