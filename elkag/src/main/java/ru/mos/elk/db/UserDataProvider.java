...
import ru.mos.elk.R;
import ru.mos.elk.db.UserData.BlackList;
import ru.mos.elk.db.UserData.Cars;
import ru.mos.elk.db.UserData.Flats;
import ru.mos.elk.db.UserData.RoadGroups;
import ru.mos.elk.db.UserData.Roads;
import ru.mos.elk.db.UserData.Subscriptions;
import ru.mos.elk.db.UserData.Times;
...
public class UserDataProvider extends ContentProvider{
    ...
    private static void generateStaticData(Context context){
        ...
        matcher.addURI(AUTHORITY, Cars.URI_CONTENT, MATCH_CARS_URI_CONTENT);
        matcher.addURI(AUTHORITY, Cars.URI_CONTENT + "/#", MATCH_CARS_URI_CONTENT_ITEM);
        matcher.addURI(AUTHORITY, BlackList.URI_CONTENT, MATCH_BLACKLIST_URI_CONTENT);
        matcher.addURI(AUTHORITY, BlackList.URI_CONTENT + "/#", MATCH_BLACKLIST_URI_CONTENT_ITEM);
        matcher.addURI(AUTHORITY, Times.URI_CONTENT, MATCH_TIMES_URI_CONTENT);
        matcher.addURI(AUTHORITY, Times.URI_CONTENT + "/#", MATCH_TIMES_URI_CONTENT_ITEM);
        matcher.addURI(AUTHORITY, Subscriptions.URI_CONTENT, MATCH_SUBSCRIPTIONS_URI_CONTENT);
        matcher.addURI(AUTHORITY, Subscriptions.URI_CONTENT + "/#", MATCH_SUBSCRIPTIONS_URI_CONTENT_ITEM);
        matcher.addURI(AUTHORITY, Roads.URI_CONTENT, MATCH_ROADS_URI_CONTENT);
        matcher.addURI(AUTHORITY, Roads.URI_CONTENT + "/#", MATCH_ROADS_URI_CONTENT_ITEM);
        matcher.addURI(AUTHORITY, RoadGroups.URI_CONTENT, MATCH_ROADGROUPS_URI_CONTENT);
        matcher.addURI(AUTHORITY, RoadGroups.URI_CONTENT + "/#", MATCH_ROADGROUPS_URI_CONTENT_ITEM);
        matcher.addURI(AUTHORITY, Flats.URI_CONTENT, MATCH_FLATS_URI_CONTENT);
        matcher.addURI(AUTHORITY, Flats.URI_CONTENT + "/#", MATCH_FLATS_URI_CONTENT_ITEM);
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs, String sortOrder) {
        ...
        switch (matcher.match(uri)) {
            case MATCH_CARS_URI_CONTENT:{
                query.setTables(Cars.TABLE_NAME);
                break;
            }
            ...
            case MATCH_BLACKLIST_URI_CONTENT:{
                query.setTables(BlackList.TABLE_NAME);
                break;
            }
            ...
            case MATCH_TIMES_URI_CONTENT:{
                query.setTables(Times.TABLE_NAME);
                break;
            }
            ...
            case MATCH_SUBSCRIPTIONS_URI_CONTENT:{
                query.setTables(Subscriptions.TABLE_NAME);
                break;
            }
            ...
            case MATCH_ROADS_URI_CONTENT:{
                query.setTables(Roads.TABLE_NAME);
                break;
            }
            ...
            case MATCH_ROADGROUPS_URI_CONTENT:{
                query.setTables(RoadGroups.TABLE_NAME);
                break;
            }
            ...
            case MATCH_FLATS_URI_CONTENT:{
                query.setTables(Flats.TABLE_NAME);
                break;
            }
